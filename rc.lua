...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "WEB", "PICS", "TERM", "FILES", "ROFI", "DEX", "CODE", "DISCORD", "TWITTER" }, s, awful.layout.layouts[1])
    ...
    -- Create the wibox
    --- Margin Around Wibox
    s.mywibox = awful.wibar({	border_width = 28,}) --------Wibar Boarder Size
    s.mywibox.widget = {
...
--Media keys supported by mpd.
    ...
    --Terminator
    awful.key({ modkey,   }, "Return", function() awful.util.spawn("terminator -e fish") end,
        {description = "Terminator", group = "Terminal"}),  
        
    --File Managers
    --Ranger
    awful.key({ modkey, "Shift"  }, "t", function() awful.util.spawn( "terminator -e ranger") end,
        {description = "Ranger", group = "File Manager"}),

    awful.key({ modkey, "Shift"  }, "n", function () awful.util.spawn( "terminator -e nnn" ) end,
    ...
    --Discord    
     awful.key({ modkey,"Shift" }, "d", function () awful.util.spawn( "Ripcord" ) end,
        {description = "Ripcord", group = "Social"}),  
    --DeDBEEF  
     awful.key({ modkey, }, "d", function () awful.util.spawn( "deadbeef" ) end,
    ...
    awful.key({ modkey }, "w", function () awful.util.spawn( "brave-browser" ) end,
        ...
        --Obsidian
        awful.key({ modkey }, "o", function () awful.util.spawn( "/home/dmne/Downloads/Obsidian-0.14.6.AppImage" ) end,
            {description = "Obsidian", group = "Editor"}), 
    --Logout
    awful.key({ modkey }, "x", function () awful.util.spawn( "lxsession-logout" ) end,
